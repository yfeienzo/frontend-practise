        ...
        <div className="flex h-screen justify-center items-center bg-[#151515]">
            <div className="w-[384px] h-[522px] bg-[#1f1f1f] flex justify-center items-center p-6 rounded-2xl">
                <div className="w-[336px] text-[#f1f1f1] text-center">
                   ...
                   <div className="cursor-pointer hover:bg-[#c4f82a] hover:text-[#343433] bg-[#343433] text-[14px] font-bold rounded-md leading-8 mb-2 h-[32px]">Twitter</div>
                   <div className="cursor-pointer hover:bg-[#c4f82a] hover:text-[#343433] bg-[#343433] text-[14px] font-bold rounded-md leading-8 mb-2 h-[32px]">Instagram</div>
                </div>
            </div>
        </div>
    )
